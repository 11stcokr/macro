      ...
      0
        ...
        private void signInWay()
        {
            try
            {
                ...
                {
                    if (this.logCheck)
                        this.log += this.fileService.logMsg("11st login");
                    IWebElement element = this.driver.FindElement(By.Id("memId"));
                    string text1 = this.id_text_box.Text;
                    element.SendKeys(text1);
                    element = this.driver.FindElement(By.Id("memPwd"));
        ...
        public void buy()
        {
            try
            {
                ...
                if (!flag)
                    this.State.Text = "상품 옵션 정보를 찾고 있습니다";
